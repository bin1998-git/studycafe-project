...
INSERT INTO MEMBER_TICKET (member_id, ticket_id)
VALUES (1, 1), -- 아령: 30시간권 (시간권 -> 일반석 이용 가능)
       (2, 4), -- 덤벨: 14일권 (기간권 -> 프리미엄석 이용 가능)
       (3, 2), -- 벤치: 50시간권 (시간권 -> 일반석 이용 가능)
       (4, 5), -- 스쿼트: 30일권 (기간권 -> 프리미엄석 이용 가능)
       (5, 6);
-- 데드리프트: 60일권 (기간권 -> 프리미엄석 이용 가능)

-- SEAT 샘플 데이터 
INSERT INTO SEAT (seat_number, seat_type, status, zone)
VALUES ('A01', 'STANDARD', 'AVAILABLE', '집중존'),
